...
public class decisionTreeNode{
    ...
    public String DFS(String test){
            ...
            for(String i : this.values){
                //System.out.print(i + " ");
                cur ++;
                if(i.indexOf(attribute) != -1 || i.equals("other")){
	...
	public String[] classify(String[] table, String set){
         ...
         for(int i = 0; i < tmp.length; i ++){
                ...
                for(String value : values){
                    if(value.indexOf(attribute) != -1 || value.equals("other")){
                        ans[num] += tmp[i] + "&";
                        break;
                    }
                    num ++;
    ...
    public double[] calMajorityError(String[] table, String set){
